...
mr -o EELSwithSample_lowfreq_ideal_test.gdf EELS_test.mr gpt EELS_ideal.in E0=2.9e6 phi110=1.1 Isol2=500.08 Isol3=921.00 scale=20 N=10000 B0=3e-3 outputZ=2.2 zsample=0.53 sc=1 streak=1 div=8e5