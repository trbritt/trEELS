...
REM E0=2.9e6 phi=0.66 Isol2=500.08 Isol3=921.00 phi110=1.27 transltated 
REM E0=2.9e6 phi=0.589 Isol2=607.14 Isol3=930.21 phi110=0.803 translated 2
REM E0=2.93e6 phi=0.651 Isol2=60 Isol3=933 phi110=1.16	translated 3
REM E0=2.929e6 phi=0.65 Isol2=575.8 Isol3=933.15 phi110=1.16 emit x same identically

REM *below is optimised params at 1e4 with higher effective bunch charge* 
mr -o EELSwithoutSample_lowfreq_ideal.gdf EELS.mr gpt EELS_ideal.in E0=2.929e6 phi=0.65 Isol2=575.8 Isol3=924.00 phi110=1.2 B0=3e-3 N=10000 sc=1 streak=1 div=8e5
...
mr -o EELSwithSample_lowfreq_ideal.gdf EELS.mr gpt EELS_ideal.in E0=2.929e6 phi=0.65 Isol2=575.8 Isol3=924.00 phi110=1.2 B0=3e-3 scale=20 N=10000 outputZ=2.2 zsample=0.53 sc=1 streak=1 div=8e5
