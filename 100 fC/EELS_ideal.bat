...
mr -o EELSwithoutSample_lowfreq_ideal.gdf EELS.mr gpt EELS_ideal.in E0=2.9e6 phi=0.66 Isol2=500.08 Isol3=921.00 phi110=1.24 B0=3e-3 N=10000 sc=1 streak=1 div=8e5
...
mr -o EELSwithSample_lowfreq_ideal.gdf EELS.mr gpt EELS_ideal.in E0=2.9e6 phi=0.66 Isol2=500.08 Isol3=921.00 phi110=1.24 B0=3e-3 scale=20 N=10000 outputZ=2.2 zsample=0.53 sc=1 streak=1 div=8e5
