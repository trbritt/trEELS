...
REM E0=2.9e6 phi=0.645 Isol2=500.08 Isol3=921.00 phi110=0.795 translated 0.74

REM *below is optimised params at 1e4 with higher effective bunch charge* 
mr -o EELSwithoutSample_lowfreq_ideal.gdf EELS.mr gpt EELS_ideal.in E0=2.9e6 phi=0.645 Isol2=500.08 Isol3=921.00 phi110=1.1 N=10000 B0=3e-3 sc=1 streak=1 div=8e5
...
mr -o EELSwithSample_lowfreq_ideal.gdf EELS.mr gpt EELS_ideal.in E0=2.9e6 phi=0.645 Isol2=500.08 Isol3=921.00 phi110=1.1 scale=20 N=10000 B0=3e-3 outputZ=2.2 zsample=0.53 sc=1 streak=1 div=8e5
